...
class CTGANSynthesizer(LossValuesMixin, BaseSingleTableSynthesizer, Plugin):
    ...
    def __init__(self, metadata, enforce_min_max_values=True, enforce_rounding=True,
                 ...
                 pac=10, cuda=True, protection_level=None):

        BaseSingleTableSynthesizer().__init__(
            metadata=metadata,
    ...
    def _fit(self, processed_data):
        ...
        Args:
            processed_data (pandas.DataFrame):
                Data to be learned.
        """
        processed_data = processed_data.dataframe()
    ...
    def _generate(self, num_rows, conditions=None):
