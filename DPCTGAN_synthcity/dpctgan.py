...
class DPCTGANPlugin(Plugin):
    ...
    .. inheritance-diagram:: synthcity.plugins.privacy.plugin_dpgan.DPGANPlugin
     ...
     Conditional Tabular GAN implementation with differential privacy. The discriminator is trained using DP-SGD.
    ...
    def _fit(self, X: DataLoader, *args: Any, **kwargs: Any) -> "DPCTGANPlugin":
