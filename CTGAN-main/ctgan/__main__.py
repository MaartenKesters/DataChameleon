...
def _parse_args():
    ...
    parser.add_argument('-m', '--metadata', default='examples/csv/adult.json', help='Path to the metadata')
    ...
    parser.add_argument('--data', default='examples/csv/adult.csv', help='Path to training data')
    parser.add_argument('--output', default='output', help='Path of the output file')
